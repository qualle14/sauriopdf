...
pdf.header(44, (ctx) => {
  ctx.add({ Shape: { Rectangle: { rect: { x: 0, y: 0, width: ctx.width, height: ctx.height }, fill_color: { r: 180, g: 30, b: 30, a: 1 }, stroke_color: null, stroke_width: 0, border_radius: 0 } } });
});
...
pdf
  ...
  .hr({ color: "#e2e8f0" })
  .spacer(12)
  .p("Pago en efectivo o transferencia en un plazo de 30 días. ¡Gracias por su preferencia!", {
    color: "slategray",
    align: "Center",
    size: 10,
  });
